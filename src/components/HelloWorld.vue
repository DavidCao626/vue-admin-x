<template>
  <div class="hello">
    ...
    <app-fieldset >
       <span style="font-size:14px" slot="legend">
         基本资料
       </span>
    <!-- :style="{'width':'800px'}"  //可控制元素宽度 -->
    <app-items :label-position="labelPosition" label-width="80px" :inline="false">
      <app-items-item label="你好">
